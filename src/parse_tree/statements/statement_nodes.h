...
/**
 * A classe de nó que contém um bloco de código na árvore de análise.
 */
...
/**
 * A classe de nó que contém uma instrução de declaração de variável ou constante na árvore de análise.
 */
...
/**
 * A classe de nó que contém várias variáveis ​​ou declarações de constantes na árvore de análise.
 */
