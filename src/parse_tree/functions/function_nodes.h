...
/**
 * A classe de nó que mantém uma função na árvore de análise.
 */
...
/**
 * A classe de nó que contém uma expressão de chamada de função na árvore de análise.
 */
...
/**
 * A classe de nó que contém uma instrução de retorno na árvore de análise.
 */
